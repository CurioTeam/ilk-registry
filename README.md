...
A publicly-modifiable registry of `ilk`'s (collaterals assets) in Curio Stablecoin system.
...
Provides an on-chain list of `ilk` types in the Curio Stablecoin system.
